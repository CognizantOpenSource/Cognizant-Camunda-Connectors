...
public class PageNumber {
    ...
    public PageNumber withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public PageNumber withConfidence(Double confidence) {
        this.confidence = confidence;
        return this;
    }
    ...
    public PageNumber withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PageNumber.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("value");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PageNumber) == false) {
            return false;
        }
        PageNumber rhs = ((PageNumber) other);
