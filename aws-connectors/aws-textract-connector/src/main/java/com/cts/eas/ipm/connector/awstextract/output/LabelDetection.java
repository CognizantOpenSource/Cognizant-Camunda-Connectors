...
public class LabelDetection {
    ...
    public LabelDetection withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public LabelDetection withGeometry(Geometry geometry) {
        this.geometry = geometry;
        return this;
    }
    ...
    public LabelDetection withConfidence(Double confidence) {
        this.confidence = confidence;
        return this;
    }
    ...
    public LabelDetection withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LabelDetection.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("text");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LabelDetection) == false) {
            return false;
        }
        LabelDetection rhs = ((LabelDetection) other);
