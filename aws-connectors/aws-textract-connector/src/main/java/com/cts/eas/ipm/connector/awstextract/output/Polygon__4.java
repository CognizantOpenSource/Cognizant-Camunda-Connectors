...
public class Polygon__4 {
    ...
    public Polygon__4 withX(Double x) {
        this.x = x;
        return this;
    }
    ...
    public Polygon__4 withY(Double y) {
        this.y = y;
        return this;
    }
    ...
    public Polygon__4 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Polygon__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("x");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Polygon__4) == false) {
            return false;
        }
        Polygon__4 rhs = ((Polygon__4) other);
