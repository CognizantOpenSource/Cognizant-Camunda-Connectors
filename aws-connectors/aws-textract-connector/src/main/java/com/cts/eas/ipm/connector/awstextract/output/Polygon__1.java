...
public class Polygon__1 {
    ...
    public Polygon__1 withX(Double x) {
        this.x = x;
        return this;
    }
    ...
    public Polygon__1 withY(Double y) {
        this.y = y;
        return this;
    }
    ...
    public Polygon__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Polygon__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("x");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Polygon__1) == false) {
            return false;
        }
        Polygon__1 rhs = ((Polygon__1) other);
