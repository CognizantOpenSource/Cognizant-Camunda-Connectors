...
public class BoundingBox__2 {
    ...
    public BoundingBox__2 withWidth(Double width) {
        this.width = width;
        return this;
    }
    ...
    public BoundingBox__2 withHeight(Double height) {
        this.height = height;
        return this;
    }
    ...
    public BoundingBox__2 withLeft(Double left) {
        this.left = left;
        return this;
    }
    ...
    public BoundingBox__2 withTop(Double top) {
        this.top = top;
        return this;
    }
    ...
    public BoundingBox__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(BoundingBox__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("width");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BoundingBox__2) == false) {
            return false;
        }
        BoundingBox__2 rhs = ((BoundingBox__2) other);
