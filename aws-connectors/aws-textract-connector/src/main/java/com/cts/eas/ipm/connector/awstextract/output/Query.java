...
public class Query {
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.alias == rhs.alias)||((this.alias!= null)&&this.alias.equals(rhs.alias)))&&((this.text == rhs.text)||((this.text!= null)&&this.text.equals(rhs.text))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
