...
public class LabelDetection__1 {
    ...
    public LabelDetection__1 withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public LabelDetection__1 withGeometry(Geometry__2 geometry) {
        this.geometry = geometry;
        return this;
    }
    ...
    public LabelDetection__1 withConfidence(Double confidence) {
        this.confidence = confidence;
        return this;
    }
    ...
    public LabelDetection__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LabelDetection__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("text");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LabelDetection__1) == false) {
            return false;
        }
        LabelDetection__1 rhs = ((LabelDetection__1) other);
