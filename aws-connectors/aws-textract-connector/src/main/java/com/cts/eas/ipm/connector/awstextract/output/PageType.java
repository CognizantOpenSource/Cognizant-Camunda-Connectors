...
public class PageType {
    ...
    public PageType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public PageType withConfidence(Double confidence) {
        this.confidence = confidence;
        return this;
    }
    ...
    public PageType withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PageType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("value");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PageType) == false) {
            return false;
        }
        PageType rhs = ((PageType) other);
