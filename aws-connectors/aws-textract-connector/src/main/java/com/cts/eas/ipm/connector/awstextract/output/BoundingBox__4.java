...
public class BoundingBox__4 {
    ...
    public BoundingBox__4 withWidth(Double width) {
        this.width = width;
        return this;
    }
    ...
    public BoundingBox__4 withHeight(Double height) {
        this.height = height;
        return this;
    }
    ...
    public BoundingBox__4 withLeft(Double left) {
        this.left = left;
        return this;
    }
    ...
    public BoundingBox__4 withTop(Double top) {
        this.top = top;
        return this;
    }
    ...
    public BoundingBox__4 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(BoundingBox__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("width");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BoundingBox__4) == false) {
            return false;
        }
        BoundingBox__4 rhs = ((BoundingBox__4) other);
