...
public class BoundingBox__1 {
    ...
    public BoundingBox__1 withWidth(Double width) {
        this.width = width;
        return this;
    }
    ...
    public BoundingBox__1 withHeight(Double height) {
        this.height = height;
        return this;
    }
    ...
    public BoundingBox__1 withLeft(Double left) {
        this.left = left;
        return this;
    }
    ...
    public BoundingBox__1 withTop(Double top) {
        this.top = top;
        return this;
    }
    ...
    public BoundingBox__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(BoundingBox__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("width");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BoundingBox__1) == false) {
            return false;
        }
        BoundingBox__1 rhs = ((BoundingBox__1) other);
