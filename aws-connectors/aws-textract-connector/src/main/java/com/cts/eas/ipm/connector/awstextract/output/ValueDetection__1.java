...
public class ValueDetection__1 {
    ...
    public ValueDetection__1 withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public ValueDetection__1 withConfidence(Double confidence) {
        this.confidence = confidence;
        return this;
    }
    ...
    public ValueDetection__1 withNormalizedValue(NormalizedValue normalizedValue) {
        this.normalizedValue = normalizedValue;
        return this;
    }
    ...
    public ValueDetection__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ValueDetection__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("text");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ValueDetection__1) == false) {
            return false;
        }
        ValueDetection__1 rhs = ((ValueDetection__1) other);
